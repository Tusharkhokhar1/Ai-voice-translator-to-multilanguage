...
def transcribe_audio(audio_file):
    aai.settings.api_key = "611f2e08baea4f9e8d7e61997530f8ed"
...
def text_to_speech(text: str) -> str:
    ...
    client = ElevenLabs(
        api_key= "sk_5c93d137a1b463739766251c45152af2948c9d78aa459544"
    )

    # Calling the text_to_speech conversion API with detailed parameters
    response = client.text_to_speech.convert(
        voice_id="2ajXGJNYBR0iNHpS4VZb", #clone your voice on elevenlabs dashboard and copy the id
...
if __name__ == "__main__":
    demo.launch(auth = ('user123','12345'), auth_message="Enter the username and password for login")